...
export const FacebookIc = () => {
  return (
    <div href="#" aria-label="Facebook" className="hover:opacity-80">
...
export const Tiktok = () => {
  return (
    <div href="#" aria-label="TikTok" className="hover:opacity-80">
      <svg
        fill="#ffffff"
        className="w-10 h-10"
        viewBox="0 0 32 32"
...
export const InstagramIc = () => {
  return (
    <div href="#" aria-label="Instagram" className="hover:opacity-80 text-with">
      <svg
        className="w-10 h-10"
        viewBox="0 0 24 24"
        fill="none"
